                      ...
                      <div className="relative z-10">
                        <div className="flex items-start justify-between gap-4 mb-5">
                          <div className="text-left">
                            ...
                            <span className={`inline-flex items-center gap-2 text-sm font-black tracking-[0.16em] px-2.5 py-1 rounded-full border mt-2 ${accent.chip}`}>
                              {period.range}
                            </span>
                          </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div>
                      ...
                      <span className={`inline-flex items-center gap-2 text-sm font-black tracking-[0.16em] px-2.5 py-1 rounded-full border mt-2 ${accent.chip}`}>{period.range}</span>
                    </div>
