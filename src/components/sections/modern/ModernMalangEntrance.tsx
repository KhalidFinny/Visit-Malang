        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-16">
          ...
          <div className="max-w-2xl">
            ...
            <motion.h2
              ...
              className="text-editorial text-6xl md:text-8xl text-[#0A0A0A] leading-[0.85] tracking-tighter uppercase mb-8 text-balance"
            >
              {t('tech.entrance.title')}
            </motion.h2>
          ...
          >
            <div className="relative group cursor-pointer" onClick={() => navigate("/modern-malang")}>
              ...
              <button className="relative px-12 py-6 bg-[#0A0A0A] text-white text-sm font-black uppercase tracking-[0.4em] rounded-full hover:bg-[#4A5759] transition-all duration-500 whitespace-nowrap shadow-xl">
                {t('tech.entrance.cta')}
              </button>
            </div>
          </motion.div>
