    ...
    >
      <div className="p-5 sm:p-6">
        ...
        <div className="flex items-start justify-between gap-4 mb-3">
          <span
            className="inline-block text-sm font-bold uppercase tracking-wider px-2.5 py-1 rounded-full shrink-0"
            style={{
        ...
        {/* Subtitle */}
        <p className="text-sm sm:text-sm font-medium leading-snug mb-3 text-[#0A0A0A]/60">
          {entry.subtitle}
        </p>
        ...
        <span
          className="mt-4 inline-flex items-center justify-center px-6 py-2.5 rounded-xl text-sm font-bold uppercase tracking-wider"
          style={{
