...
export default function WeatherFooter({ activeIndex, totalItems }: WeatherFooterProps) {
  return (
    <footer className="flex justify-between items-center py-8 border-t-2 border-white/20">
      <div className="flex items-center gap-6">
        <span className="text-swiss text-lg tracking-[0.2em] text-white uppercase font-black">
      ...
      <span className="text-swiss text-lg tracking-[0.1em] text-white/50 font-black uppercase hidden md:block">
