...
const PlaceDetail = () => {
 ...
 <h2
 className={`text-editorial text-2xl md:text-3xl uppercase tracking-tighter leading-[0.92] mb-4 text-balance break-words ${
 ...
 <div className="absolute inset-0 w-full px-4 sm:px-6 md:px-8 xl:px-10 z-10 flex flex-col justify-end h-full pb-12 sm:pb-20 md:pb-24">
 <motion.div
 ...
 <span className="text-swiss text-sm sm:text-sm md:text-sm font-bold tracking-[0.25em] sm:tracking-[0.3em] text-[#A3B18A] uppercase">
 {data.tagline}
 </span>
 </div>
 )}
 ...
 <p className="text-white/70 text-sm sm:text-base md:text-lg leading-relaxed font-medium text-balance py-1">
 {data.description}
 </p>
 </motion.div>
 </div>
 ...
 <div className="w-full px-4 sm:px-6 md:px-8 xl:px-10 relative z-10">
 ...
 <div>
 <h4 className="text-swiss text-sm font-bold tracking-[0.15em] uppercase text-[#2D221F]/40 mb-1">
 ...
 target="_blank"
 rel="noreferrer"
 className="inline-flex items-center gap-3 px-8 py-4 bg-[#2D221F] text-white text-sm font-black uppercase tracking-[0.15em] rounded-full hover:bg-[#A3B18A] transition-all duration-300"
 >
 ...
 <p className="text-swiss text-lg md:text-xl italic leading-relaxed text-[#2D221F]/80 relative z-10 border-l-4 border-[#A3B18A] pl-6 py-2">
 {data.story}
 </p>
 </div>
 </motion.div>
 ...
 <h4 className="text-swiss text-sm font-black tracking-[0.15em] uppercase text-[#A3B18A] mb-3">
 ...
 <p className="text-[#2D221F]/60 text-sm md:text-sm leading-relaxed ">
 ...
 <div className="sticky top-0 z-30 bg-[#f5f4f0] pt-8 pb-6 mb-8 -mx-4 px-4 sm:-mx-6 sm:px-6 md:-mx-8 md:px-8 xl:-mx-10 xl:px-10">
 ...
 <div
 key={i}
 className="sticky overflow-hidden rounded-2xl bg-white text-[#2D221F] flex flex-col md:flex-row border border-[#2D221F]/5"
 style={{
 position: "sticky",
 top: "15vh",
 zIndex: i + 1,
 ...
 <p className="text-[#2D221F]/60 text-sm md:text-base leading-relaxed">
 {exp.desc}
 </p>
 </div>
 ...
 <span
 className="px-3 py-1 rounded-full text-sm font-black tracking-widest uppercase bg-[#f5f4f0] border border-[#2D221F]/5"
 style={{ color: bt.color || "#A3B18A" }}
 >
 {bt.badge}
 </span>
 ...
 <p className="text-sm md:text-sm leading-relaxed text-[#2D221F]/70">{fact}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 />
 <div className="absolute top-3 left-3 bg-[#A3B18A] text-white text-sm font-black tracking-[0.15em] uppercase px-3 py-1.5 rounded-full shadow-sm">
 ...
 <p className="text-sm text-[#2D221F]/60 leading-relaxed font-sans mb-6">
 {place.description}
 </p>
 
 {/* Minimal interactive CTA at bottom */}
 <div className="mt-auto pt-4 border-t border-[#2D221F]/5 flex items-center justify-between">
 <span className="text-sm font-black uppercase tracking-widest text-[#2D221F]/80 group-hover:translate-x-1 transition-transform duration-300 flex items-center gap-1 font-sans">
