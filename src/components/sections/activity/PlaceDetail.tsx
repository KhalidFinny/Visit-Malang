...
import { FALLBACK_ALTITUDES, FALLBACK_FEES, FALLBACK_SAFETY } from "./placeFallbackData";
...
const PlaceDetail = () => {
  ...
  useEffect(() => {
    ...
    setSafety(FALLBACK_SAFETY[slug] ? {
      ...FALLBACK_SAFETY[slug],
      contextType:
        slug.includes("bromo") || slug.includes("semeru") || slug.includes("budug") || slug.includes("asu")
          ? "trail"
          : "urban",
    } as PlaceSafetyData : null);
    setFees(FALLBACK_FEES[slug] ?? null);
    setAltitude(FALLBACK_ALTITUDES[slug] ?? null);
  }, [slug]);
