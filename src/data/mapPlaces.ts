// Curated top-5 places per category for the Hero Map
// Coordinates are real GPS locations in Malang city proper (NOT Batu)
...
export const MAP_PLACES: MapPlace[] = [
  // ── NATURE ──────────────────────────────────────────────────────────────
  // Note: Bromo & Tumpak Sewu are day-trips from Malang, coords kept honest
  {
    id: 'nature_001',
    name: 'Mount Bromo',
  ...
  // ── ATTRACTION ───────────────────────────────────────────────────────────
  // Replaced all Batu-based attractions with Malang city proper attractions
  {
    id: 'attraction_006',
